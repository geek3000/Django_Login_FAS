"""
Django settings for django_fasid project.
...
SECRET_KEY = '2ddvktr-wmjpldlu=aw!=4n+%ma%946$%du+i_z20-x^0npgp#'
...
ROOT_URLCONF = 'django_fasid.urls'
...
WSGI_APPLICATION = 'django_fasid.wsgi.application'
